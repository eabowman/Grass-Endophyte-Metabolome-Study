The folders here contain R scripts and data files for the article "Chemistry, symbiosis, and the phylogenetic architecture of grass communities." written by Elizabeth A. Bowman and Colin Morrison.
